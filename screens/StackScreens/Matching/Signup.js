...
const Signup = ({navigation:{navigate}})=>{
    ...
    return(
        <Container>
            ...
            <BoardTextBox>
                <TitleText>한국공대 선후배 등록하기</TitleText> 
            </BoardTextBox>
            <PlusBtn> 
            ...
            <MajorBox>
            <NameBox1>
                <Input title="이름" changeText={setnameChange} mbottom="3"/>
            </NameBox1>
            </MajorBox>
            <MajorBox2>
                <NameBox1>
                    <SmallText>학과</SmallText>
                </NameBox1>
                <NameBox2>
                    <NameBtn onPress={()=>setModalVisible2(true)}>
                        <NameText>학과를 입력하세요</NameText>
                        <NameText>▼</NameText>
                    </NameBtn>
                </NameBox2>
            </MajorBox2>
            <MajorBox2>
                <NameBox1>
                    <SmallText>세부학과를 입력하세요</SmallText>
                </NameBox1>
                <NameBox2>
                    <NameBtn onPress={()=>setModalVisible2(true)}>
                        <NameText>학과를 입력하세요</NameText>
            ...
            <MajorBox>
            <NameBox1>
                <Input title="연락처" changeText={setnameChange} mbottom="10"/>
            </NameBox1>
            </MajorBox>
            <EyeBox>
                <EyeBtn 
